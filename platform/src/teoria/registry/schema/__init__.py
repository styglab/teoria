from teoria.registry.schema.capability import CapabilityDefinition, CapabilityRegistry
from teoria.registry.schema.data_type import DataTypeDefinition, DataTypeRegistry
